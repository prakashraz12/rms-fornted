...
import { BILL_STATUS, PAYMENT_METHODS } from "@/constant";
  ...
  return (
    <div className="mx-auto container mt-8">
      ...
      <div className="flex flex-col space-y-4 lg:flex-row lg:space-y-0 lg:space-x-6 mb-4 mt-5">
        ...
        <div className="flex flex-col lg:flex-1">
          <p className="text-sm mb-1 ml-2">Payment Method</p>
          <Select
            value={paymentMethod}
        ...
        <div className="flex flex-col lg:flex-1">
          <p className="text-sm mb-1 ml-2">Bill Status</p>
          <Select
            value={billStatus}
